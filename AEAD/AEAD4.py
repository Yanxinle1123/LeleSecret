...
def decryption():
    try:
        AEADDM = AEADDecryptionMethod(decryption_text_need.get_content(), key_text_need.get_content())
...
window = tk.Tk()
EasyAutoWindow(window, window_title="AEADMethod", minimum_value_x=1312, minimum_value_y=876,
